...
const Contact = () => {
  ...
  <div className="container md:py-[80]   mx-auto ">
  ...
  <section className="text-primary body-font relative pb-12">
    <div className="container px-5 py-8 mx-auto flex sm:flex-nowrap flex-wrap">
      ...
      <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
        ...
        <button className="text-texcol bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-secondary rounded text-lg">Button</button>
